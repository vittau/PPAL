 ...
 */
public class BasicDisjunctionOperatorTest {
	...
	public void symmetry() {
		...
		BinaryOperator andOp = new BasicDisjunctionOperator(ev, ev2);
		BinaryOperator andOpSym = new BasicDisjunctionOperator(ev2, ev);
